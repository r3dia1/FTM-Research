...
def main():
    ...
    for seed in seed_candidate:
        ...
        print(f"{'Epoch':<6} | {'Total Loss':<10} | {'Train Cls':<10} | {'Train D_RSSI':<12} | {'Train D_RTT':<11} | {'Val S Acc':<10} | {'Val T Entropy':<10} | {'Save':<11} | {'Test MDE':<8} | {'Score':<7}")
        print("-" * 135)
        ...
        for epoch in range(num_epochs):
            ...
            print(f"{epoch+1:<6} | {avg_total:<10.4f} | {avg_cls:<10.4f} | {avg_d_rssi:<12.4f} | {avg_d_rtt:<11.4f} | {val_s_acc:<10.4f} | {val_t_entropy:<10.4f} | {save_mark:<11} | {t_mde:<8.4f} | {current_score:<7.3f}")
