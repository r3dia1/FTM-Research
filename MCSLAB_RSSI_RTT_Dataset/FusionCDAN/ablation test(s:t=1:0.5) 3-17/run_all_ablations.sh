...
ARCHITECTURES=(
    # "CDAN/cdan.py"
    # "CDAN dace/cdan_dace.py"
    # "CDAN dace gac/cdan_dace_gac.py"
    # "CDAN gac/cdan_gac.py"
    # "CDAN rssi diff/cdan_rssi_diff.py"
    # "CDAN dace rssi diff/cdan_dace_rssi_diff.py"
    # "CDAN/cdan_withVS.py"
    # "FusionCDAN/fusion_cdan.py"
    # "FusionCDAN Rssi Diff/fusion_cdan_rssi_diff.py"
    "FusionCDAN dace/fusioncdan_dace.py"
    # "FusionCDAN dace gac/fusioncdan_dace_gac.py"
    # "FusionCDAN gac/fusioncdan_gac.py"
    # "DuGDA/DuGDA.py"
    # "GACDAN/ga_cdan_withVS.py"
)
