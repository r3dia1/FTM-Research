...
# 設定 Python 腳本路徑
PYTHON_SCRIPT="ga_cdan_v6_robust_test.py"
# 設定資料集的 Base Path (請修改為你的實際路徑)
BASE_PATH=".." 
TEST_PATH="../2026_2_11/All_Data_With_RSSI_Diff_withoutNA.csv"
...
for combo in "${all_combos[@]}"; do
    ...
    python $PYTHON_SCRIPT --rtt_indices "$combo" --base_path "$BASE_PATH" --future_csv "$TEST_PATH" > "logs/log_${combo_name}.txt"
